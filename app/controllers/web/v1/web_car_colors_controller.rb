class Web::V1::WebCarColorsController < ApplicationController
  ...
  def create
    ...
    @web_car_color.color_name = params[:web_car_color][:color_name]
  ...
  def update
    ...
    if @web_car_color.update(web_car_color_params)
      @web_car_color.update(color_name: params[:web_car_color][:color_name])
  ...
  def delete_web_car_colors
    @web_car_colors = params[:web_car_color_ids]
    @web_car_colors.each do |acc|
      WebCarColor.find(acc).destroy
    end
    head :no_content 
  end
