...
ActiveRecord::Schema.define(version: 2018_06_15_053715) do
  ...
  create_table "bike_types", id: :serial, force: :cascade do |t|
    t.string "name"
    t.text "tagline"
  ...
  create_table "booking_time_controls", id: :serial, force: :cascade do |t|
    t.time "open_time"
    t.time "end_time"
  ...
  create_table "hog_registrations", id: :serial, force: :cascade do |t|
    t.string "full_name"
    t.string "email"
    t.string "mobile"
    t.date "dob"
  ...
  create_table "insurance_renewals", id: :serial, force: :cascade do |t|
    t.string "name"
    t.string "email"
    t.string "mobile"
    t.string "address"
  ...
  create_table "my_bikes", id: :serial, force: :cascade do |t|
    t.string "bike"
    t.date "purchase_date"
    t.string "registration_number"
  ...
  create_table "service_bookings", id: :serial, force: :cascade do |t|
    t.integer "user_id"
  ...
  create_table "specification_types", id: :serial, force: :cascade do |t|
    t.string "name"
    t.integer "display_order"
    t.boolean "active"
    t.datetime "created_at", null: false
  ...
  create_table "test_rides", id: :serial, force: :cascade do |t|
    t.integer "user_id"
    t.string "name"
    t.string "mobile"
    t.string "email"
  ...
  create_table "vehicle_faqs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["bike_id"], name: "index_vehicle_faqs_on_bike_id"
  end
